...
<head>
    ...
    <title>Contact Us - Find Business | India's Leading Business Directory</title>
    <meta name="description" content="Get in touch with Find Business. Contact us for business listings, support, or any inquiries.">
    <!-- Favicon -->
            ...
            <div class="contact-info-cards">
                ...
                <div class="info-card">
                    <div class="info-card-icon">
                     ...
                     <div class="info-card-content">
                        <h3>Phone Number</h3>
                        <p>+91 97145 84578<br>+91 85119 11658</p>
                ...
                <div class="info-card">
                    ...
                    <div class="info-card-content">
                        <h3>Email Address</h3>
                        <p>info@find-business.com<br>support@find-business.in</p>
    ...
    <section class="faq-section">
        <div class="faq-container">
            <div class="section-header">
                ...
                <p>Find answers to commonly asked questions about Find Business</p>
            </div>
            <div class="faq-grid">
                <div class="faq-item">
                    <button class="faq-question">
                        <span>How can I list my business on Find Business?</span>
    ...
    <section class="cta-section">
        <div class="cta-container">
            <div class="cta-content">
                ...
                <p>Join thousands of businesses already listed on Find Business and reach millions of potential customers across India.</p>
                <div class="cta-buttons">
                    <a href="add_business.php" class="btn btn-white">
