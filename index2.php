...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-container">
            <a href="index.php" class="nav-logo">
                ...
                <span>Bharat Directory</span>
            </a>

            <ul class="nav-menu">
                <li><a href="#home" class="nav-link"><i class="fas fa-home"></i> Home</a></li>
                <li><a href="#categories" class="nav-link"><i class="fas fa-th-large"></i> Categories</a></li>
                <li><a href="#industries" class="nav-link"><i class="fas fa-industry"></i> Industries</a></li>
                <li><a href="google_results.php" class="nav-link"><i class="fab fa-google"></i> Google Search</a></li>
                <li><a href="#contact" class="nav-link"><i class="fas fa-envelope"></i> Contact</a></li>
                <li><a href="add_business.php" class="nav-link nav-btn"><i class="fas fa-plus"></i> Add Business</a></li>
            </ul>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <ul class="mobile-menu-links">
            ...
            <li><a href="#industries"><i class="fas fa-industry"></i> Industries</a></li>
            <li><a href="google_results.php"><i class="fab fa-google"></i> Google Search</a></li>
            <li><a href="#contact"><i class="fas fa-envelope"></i> Contact</a></li>
            <li><a href="add_business.php"><i class="fas fa-plus"></i> Add Business</a></li>
        </ul>
    </div>
