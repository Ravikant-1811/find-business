<!-- ============================================
     ...
     Mobile Friendly Version + Mobile Bottom Nav
============================================ -->
...
.find-business-download {
    margin-top: 1.3rem;
}

.find-business-download-title {
    font-size: 0.9rem;
    color: #ffffff;
    font-weight: 600;
    margin-bottom: 0.6rem;
...
.google-play-btn:hover img {
    ...
    /* ============================================
       MOBILE BOTTOM NAV – FIND BUSINESS (≤ 768px)
    ============================================ */
    @media (max-width: 768px) {
        body {
...
/* =========================================
   ANDROID APP VIEW ONLY
   Hide Website Footer + Mobile Bottom Nav
========================================= */
.app-view footer.footer,
.app-view .footer,
.app-view .footer-newsletter,
.app-view .footer-main,
.app-view .footer-bottom,
.app-view .mobile-bottom-nav,
.app-view .mobile-bottom-nav-safe,
.app-view .back-to-top {
    display: none !important;
...
/* App spacing (Android has native bottom nav) */
.app-view body {
                ...
                <div class="footer-brand">
                    <a href="index.php" class="footer-logo">
                        ...
                        <div class="footer-logo-text">
                            <span class="footer-logo-name">Find Business</span>
                    ...
                    <div class="find-business-download">
    <p class="find-business-download-title">
        Find Business App is Now Live
    </p>

    <a 
        href="https://play.google.com/store/apps/details?id=com.find-business.app"
        target="_blank"
        ...
        >
                ...
                <div class="footer-column" data-accordion>
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="category.php?category=hospital"><i class="fas fa-hospital"></i> Hospitals</a></li>
                        <li><a href="category.php?category=IT+companies"><i class="fas fa-laptop-code"></i> IT & Electronics</a></li>
                ...
                <div class="footer-column" data-accordion>
                    ...
                    <ul class="footer-links">
                        ...
                        <div class="footer-contact-item">
                            ...
                            <a href="mailto:info@find-business.com">info@find-business.com</a>
                        </div>
                        <div class="footer-contact-item">
                            <span class="footer-contact-icon">
                                <i class="fas fa-phone-alt"></i>
                            </span>
                            <a href="tel:+919714584578">+91 97145 84578</a>
                        </div>
                    </ul>
                </div>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-container">
            <p class="footer-copyright">
                © 2026 <a href="/">Find Business</a>. All Rights are Reserved 
            </p>
...
<div class="mobile-bottom-nav-safe"></div>

<nav class="mobile-bottom-nav" aria-label="Primary mobile navigation">
    <a href="index.php" class="mobile-bottom-nav__item" data-nav="home">
    ...
    <a href="add_business.php" class="mobile-bottom-nav__item" data-nav="add">
        <span class="mobile-bottom-nav__icon">
    ...
    <a href="categories.php" class="mobile-bottom-nav__item" data-nav="category">
        <span class="mobile-bottom-nav__icon">
    ...
    <a href="help.php" class="mobile-bottom-nav__item" data-nav="help">
        <span class="mobile-bottom-nav__icon">
            <i class="fa-solid fa-circle-question"></i>
        </span>
        <span class="mobile-bottom-nav__label">Help</span>
    </a>
</nav>
<!-- JavaScript -->
<script>
(function() {
    ...
    function initMobileBottomNavActive() {
        ...
        navItems.forEach(function (item) {
            ...
            var navKey = (item.getAttribute('data-nav') || '').toLowerCase();

            if (matched) return;

            if (href && path.indexOf(href.replace(window.location.origin.toLowerCase(), '')) !== -1) {
            ...
            if (!matched && navKey) {
                if (navKey === 'home' && (path === '/' || path.endsWith('/index.php') || path.endsWith('/index.html'))) {
                    item.classList.add('mobile-bottom-nav__item--active');
                    matched = true;
                } else if (navKey === 'add' && path.indexOf('add_business') !== -1) {
                    item.classList.add('mobile-bottom-nav__item--active');
                    matched = true;
                } else if (navKey === 'category' && (path.indexOf('category') !== -1 || path.indexOf('categories') !== -1)) {
                    item.classList.add('mobile-bottom-nav__item--active');
                    matched = true;
                } else if (navKey === 'help' && (path.indexOf('help') !== -1 || path.indexOf('contact') !== -1 || path.indexOf('faq') !== -1)) {
                    item.classList.add('mobile-bottom-nav__item--active');
                    matched = true;
                }
            }
...
setInterval(function() {
    if (window.outerWidth - window.innerWidth > 160 || window.outerHeight - window.innerHeight > 160) {
        document.body.innerHTML = '<h1 style="text-align:center;margin-top:20%;color:red;">Developer Tools Detected</h1>';
    }
}, 1000);
</script>
